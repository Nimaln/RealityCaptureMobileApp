...
import { getManifest } from '../api/DerivativeService';
...
class ForgeViewer extends React.Component {
  ...
  componentDidMount () {
    const svfURL = `${Config.AWS_S3_BASE_ENDPOINT}/${Config.AWS_S3_BUCKET}/HIL_E9.svf`
    console.log('The svfUrl is:' + svfURL)
    //var manifestTest = getManifest() 
    //var documentId = 'urn:dXJuOmFkc2sub2JqZWN0czpvcy5vYmplY3Q6cmVhbGl0eS1jYXB0dXJlLXRlc3QvcmVhbGl0eS1jYXB0dXJlLXRlc3Quemlw'
                ...
                function initializeViewer() {
                    ...
                    Autodesk.Viewing.Initializer(options, function() {
                       // var modelOptions = { sharedPropertyDbPath: doc.getPropertyDbPath() } ;
                        //var dbPropertiesPath = 'urn:adsk.viewing:fs.file:dXJuOmFkc2sub2JqZWN0czpvcy5vYmplY3Q6cmVhbGl0eS1jYXB0dXJlLXRlc3Qtc2JzL3JlYWxpdHktY2FwdHVyZS1zYnMuemlw/output/properties.db';
                       viewer.start(\`${svfURL}\`, {} , onSuccess, onError);  
                        //viewer.start(documentId, onSuccess, onError);
                        //viewer.start(onSuccess,onError);
